...
if TYPE_CHECKING:
    from .torch.client import BastionLabTorch
    from .polars.client import BastionLabPolars
...
class Client:
    ...
    def __init__(
        ...
        self._session_stub = SessionServiceStub(channel)
    ...
    def _create_session(self):
        ...
        if self.signing_key is not None:
            ...
            challenge = self._session_stub.GetChallenge(Empty()).value
        ...
        res = self._session_stub.CreateSession(CLIENT_INFO, metadata=metadata)
...
class Connection:
    ...
    channel: grpc.Channel = None  #: The underlying gRPC channel.
    _token: Optional[bytes] = None
