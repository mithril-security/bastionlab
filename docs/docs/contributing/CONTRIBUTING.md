...
* [Documentation - BastionLab Official Documentation](https://BastionLab.mithrilsecurity.io)
...
You can find detailed explanation of how to install BastionLab in your local machine in the [official documentation](../../getting-started/quick-start.md).
