...
// impl PolicyAction {
//     pub fn reject_by_default() -> Self {
//         PolicyAction::Reject(String::from("Rejected by default"))
//     }
//     pub fn accept_by_default() -> Self {
//         PolicyAction::Reject(String::from("Accepted by default"))
//     }
// }

// impl BitAnd for PolicyAction {
//     type Output = Self;
...
// impl BitAndAssign for PolicyAction {
//     fn bitand_assign(&mut self, rhs: Self) {
//         match self {
//             PolicyAction::Accept => *self = rhs,
//             PolicyAction::Approval(_) => match rhs {
//                 PolicyAction::Accept => (),
//                 _ => *self = rhs,
//             },
...
// impl BitOrAssign for PolicyAction {
...
//                 _ => (),
//             },
//             PolicyAction::Reject(_) => *self = rhs,
//         }
//     }
// }
